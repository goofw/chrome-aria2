// https://github.com/mayswind/angular-bittorrent-peerid
...
angular.module('angularBittorrentPeerid').provider('bittorrentPeeridService', function () {
    ...
    this.$get = ['peeridUtils', function (utils) {
        ...
        var decodePercentEncodedString = function (s) {
            if (!s) {
                return s;
            }
        ...
        // https://github.com/mayswind/AriaNg
        var parseClient = function (peerId) {
            if (peerId) {
                peerId = decodePercentEncodedString(peerId);
                var clientInfo = (peerId ? parseClientFromPeerid(peerId) : null);
